...
const IteratorPrototype = Object.create(utils.IteratorPrototype, {
  next: {
    value: function next() {
      ...
      const key = pair.map(utils.tryWrapperForImpl)[0];
      const value = pair.map(utils.tryWrapperForImpl)[1]
...
URLSearchParams.prototype.append = function append(name, value) {
  ...
  return this[impl].append.apply(this,args);
};
...
URLSearchParams.prototype.delete = function _(name) {
  ...
  return this[impl].delete.apply(this, args);
};
...
URLSearchParams.prototype.get = function get(name) {
  ...
  return this[impl].get.apply(this,args);
};
...
URLSearchParams.prototype.getAll = function getAll(name) {
  ...
  return utils.tryWrapperForImpl(this[impl].getAll.apply(this, args));
};
...
URLSearchParams.prototype.has = function has(name) {
  ...
  return this[impl].has.apply(this, args);
};
...
URLSearchParams.prototype.set = function set(name, value) {
  ...
  return this[impl].set.apply(this, args);
};
...
URLSearchParams.prototype.forEach = function forEach(callback) {
  ...
  while (i < pairs.length) {
    const key = pairs[i].map(utils.tryWrapperForImpl)[0];
    const value = pairs[i].map(utils.tryWrapperForImpl)[1];
